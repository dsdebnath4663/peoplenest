...
public class OpenAPIConfig {
    ...
    @Value("${apiconfig.openapi.dev-url}")
    private String devUrl;

    @Value("${apiconfig.openapi.prod-url}")
    ...
    public OpenAPI myOpenAPI () {
        ...
        // Contact
        Contact contact = new Contact().email("dsdebnath@gmail.com").name("dsdebnath").url("https://www.dsdebnath.com");
        ...
        Info info = new Info().title("Tutorial Management API")
                ...
                .termsOfService("https://www.dsdebnath.com/terms")
                .license(mitLicense);
